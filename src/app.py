...
def unregister_participant_query(activity_name: str, email: str):
    """Backward-compatible unregister endpoint using a query parameter."""
    return unregister_participant(activity_name, email)
